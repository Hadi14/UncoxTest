      ...
      <div class="sidebar-footer">
        <a href="##" class="sidebar-user">
          <span class="sidebar-user-img">
            <picture>
              <source srcset="./img/avatar/avatar-illustrated-03.webp" type="image/webp"><img
                src="./img/avatar/avatar-illustrated-03.png" alt="User name">
            </picture>
          </span>
                ...
                <div class="row">
                  <div class="col-md-6 col-lg-4">
                    <div class="input-group mb-2">
                      ...
                      <input type="number" class="form-control" placeholder="تعداد خانوار شهری">
                    </div>
                  </div>
                  <div class="col-md-6 col-lg-4">
                    <div class="input-group mb-2">
...
<body>
    ...
    <script src="js/script.js"></script>
    <script src="js/bootstrap.bundle.min.js"></script>
>>>>>>> 81ab501588fdffa21e198390db76c32c32861b0b
</body>
